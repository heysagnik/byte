      ...
      parameters: {
        ...
        properties: {
          summary: {
            ...
            description: 'What was found and what decision needs to be made. Include key tradeoffs.',
          },
          options: {
            ...
            items: {
              ...
              properties: {
                ...
                details:     { type: SchemaType.STRING, description: 'Full specifics — time, location, terms, what happens next.' },
                price:       { type: SchemaType.STRING, description: 'Cost if applicable.' },
                recommended: { type: SchemaType.BOOLEAN, description: 'True for the option you recommend (at most one).' },
              },
