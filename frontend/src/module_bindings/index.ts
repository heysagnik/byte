...
const tablesSchema = __schema({
  Message: __table({
    ...
    indexes: [
      ...
      { accessor: 'message_thread_id', name: 'message_thread_id_idx_btree', algorithm: 'btree', columns: [
        'threadId',
      ] },
    ],
    constraints: [
  ...
  Thread: __table({
    ...
    indexes: [
      ...
      { accessor: 'thread_user_id', name: 'thread_user_id_idx_btree', algorithm: 'btree', columns: [
        'userId',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("insert_message", InsertMessageReducer),
  __reducerSchema("update_message_metadata", UpdateMessageMetadataReducer),
);
